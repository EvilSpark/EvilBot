...
module.exports = {
	...
	execute(message, args) {
		...
		return message.reply(
			'\n```There is no such argument.\nAvailable arguments are ricardo, pikagun, cylaugh, ybb, pepelmao, xqbestgirl, jasminethanos, ycthotdetected, ycstare, wc1, wc2, kitani, hiatus, jswhitetiger, jasminecry, jasminerage, jasminekick, sulinger, ycsupersaiyan, arata, ratata.\nPlease wait 60 more second(s) before reusing the atgp command.```'
		);
	}
};
